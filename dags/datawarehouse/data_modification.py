    ...
    try:
        ...
        if schema == 'staging':
            ...
            cur.execute(
                ...
                VALUES (%(video_id)s, %(title)s, %(publishedAt)s, %(duration)s, %(viewsCount)s, %(likeCount)s, %(commentCount)s);
                """, row
            )
            ...
            cur.execute(
                ...
                VALUES (%(Video_ID)s, %(Video_Title)s, %(Upload_Date)s, %(Duration)s, %(Video_Type)s, %(Video_Views)s, %(Likes,Count)s, %(Comments_Count)s)
                """, row
            )
